...
<?php
  ...
  if(count($donor)> 0){
    ...
    echo "</tr>";
    for($i = 0; $i < count($donor); $i++){
    	echo "<tr>";
    	echo "<td>" . $donor[$i]["username"] . "</td>";
    	echo "<td>" . $donor [$i]["regfor"] = "donor" . "</td>";
    	echo "<td>" . $donor[$i]["bloodgroup"] . "</td>";
    	echo "<td>" . $donor[$i]["address"] . "</td>";
    	echo "<td>" . $donor[$i]["phonenumber"] . "</td>";
      echo "<td> <a href='" . $_SERVER['PHP_SELF'] . "?uname=" . $donor[$i]["username"] ."&pnumber=" . $donor[$i]["phonenumber"] ."'>Delete</a> </td>";
    	echo "</tr>";
    }
    echo"</table>";
}
